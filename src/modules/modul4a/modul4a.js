...
export class Modul4aView extends BaseModuleView {
  ...
  init3DViewer() {
    ...
    try {
      ...
      this.threeCamera.position.set(2.25, 1.1, 2.5);
      ...
      // 3. Orbit Controls — Lock Zoom at default 200% level
      ...
      this.threeControls.minDistance = 3.55;
      this.threeControls.maxDistance = 3.55;
